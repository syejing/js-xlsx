...
Report any issues to https://github.com/syejing/js-xlsx/issues.
...
With [npm](https://www.npmjs.org/package/ch-xlsx-style):

```sh
npm install ch-xlsx-style --save
```
...
```sh
bower install js-ch-xlsx-style#beta
```
